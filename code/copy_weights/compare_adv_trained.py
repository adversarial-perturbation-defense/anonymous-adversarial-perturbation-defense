...
print("Start testing the copied version of adversarially trained MIT model.")
# Load and pick a data point.
(x_train, y_train), (x_test, y_test) = LoadCIFAR10()

# MIT model file.
model_file = tensorflow.train.latest_checkpoint('models/adv_trained')
...
copied_model = load_model('./saved_models/adv_trained_mit_model')
